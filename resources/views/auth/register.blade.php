            ...
            <div class="card my-5">
                <div class="card-body">
                    <form action="/register" method="POST">
                        ...
                        <div class="form-group mb-3">
                            <div class="form-floating mb-0">
                                <input type="tel" min="12" max="12" name="contact_no" class="form-control" id="floatingInput" placeholder="Contact number">
                        ...
                        <div class="form-group mb-3">
                            <div class="form-floating mb-0">
                                <input type="password" name="password_confirmation" class="form-control" id="floatingInput1" placeholder="Password">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-4">
                            ...
                            <a href="/app" class="link-primary">Login</a>
                        </div>
                    </form>
                </div>
            </div>
